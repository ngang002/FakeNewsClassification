...
I will conclude this Repo by making some statements.  While I have achieved ~90% accuracy rate (and similar precision, recall, and F1 scores), there are somethings that I should note.  Primarily, when consuming news we should all be aware of the biases that we have.  While I have combined multiple different datasets together, the larger the dataset, potentially the larger the bias.  No matter how much cleaning I have done, it will not change the classification of the news articles that I have.  Additionally, I have not modified the binary cutoff for which a news article is considered real/fake news, hence the intrinsic cutoff will be 0.5 (i.e. < 0.5 is fake, > 0.5 is real news).  In reality, I would more than likely increase this threshold to be higher, such that when I classify an article I would like to be sure that it is real rather than fake.  This will ultimately yield a higher recall, and lower precision score.  However, I will be more certain that if a news article is classified as real, it will be real. 
